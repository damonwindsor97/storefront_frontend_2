            ...
            <div className="grid xl:grid-cols-3 xl:gap-8 md:grid-cols-2 md:gap-8 text-white text-start">
                ...
                <div className="group border rounded-2xl p-8 overflow-hidden relative select-none border-gray-700">
                    <div className="absolute inset-0 flex justify-center items-end z-0">
                        ...
                        <p className="text-sm w-[75%] mt-4 text-gray-300 relative z-10">
                            Our team is constantly reverse engineering Anti-Cheats to ensure they're aware of all and any changes made, keeping you safe from detections.
                        </p>
                </div>
                ...
                <div className="group border rounded-2xl p-8 overflow-hidden relative select-none border-gray-700">
                    <div className="absolute inset-0 flex justify-center items-end z-0">
                        ...
                        <p className="text-sm w-[75%] mt-4 text-gray-300 relative z-10">
                            Our team of Devs only add the best, and safest features to ensure you can eliminate any opponent whilst not risking a ban.
                        </p>
                </div>
                ...
                <div className="group border rounded-2xl p-8 overflow-hidden relative select-none border-gray-700">
                    <div className="absolute inset-0 flex justify-center items-end z-0">
                        ...
                        <p className="text-sm w-[75%] mt-4 text-gray-300 relative z-10">
                            Our Cheats are tested for months in advance before being released, and any new features are tested extensively to ensure they're safe for our users.
                        </p>
                </div>
                ...
                <div className="group border rounded-2xl p-8 overflow-hidden relative select-none border-gray-700">
                    <div className="absolute inset-0 flex justify-center items-end z-0">
                        ...
                        <p className="text-sm w-[75%] mt-4 text-gray-300 relative z-10">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate error vero quia! Laborum vitae iure eius veritatis praesentium, veniam facere.
                        </p>
                </div>
                ...
                <div className="group border rounded-2xl p-8 overflow-hidden relative select-none border-gray-700">
                    <div className="absolute inset-0 flex justify-center items-end z-0">
                        ...
                        <p className="text-sm w-[75%] mt-4 text-gray-300 relative z-10">
                            Dont wait for your ke Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus laudantium iste atque illum similique maiores?
                        </p>
                </div>
                ...
                <div className="group border rounded-2xl p-8 overflow-hidden relative select-none border-gray-700">
                    <div className="absolute inset-0 flex justify-center items-end z-0">
                        ...
                        <p className="text-sm w-[75%] mt-4 text-gray-300 relative z-10">
                            Our dedicated Support Team Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus deserunt cum aperiam fugiat rem labore.
                        </p>
                </div>
